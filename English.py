...
def main_english():
    ...
    evc_code = input("Enter *770# to log in \n")
...
def Wareejint_dambesay():
    ...
    recipt_num = int(input("Please enter a mobile number \n"))
    ...
    if len(recipt_num) == 9 and (recipt_num.startswith("61") or recipt_num.startswith("77")):
        ...
        for line in lines:
            ...
            print("Operation Succeed no transaction to display ")
                # Call the main function
            main_english()
    else:
        print("The number formate is not correct")
        Wareejint_dambesay()
...
def bedel_pin():
    ...
    if len(pin)==4:
        ...
        print("Failed the pin should be 4 digits only numbers")
        bedel_pin()
...
def luqada():
    ...
    if lang == 1:
        from Somali import somali_main # Import the file contain the Somalia   translate#
...
def mobile_lumay():
    ...
    if len(num) == 9 and num.startswith("61") or num.startswith("77"):
        ...
        if pin == pinka:
            if check == 1:
                print("You have successfully registered  Thanks  ")
                main_english()
            else:
                print("Thanks!")
                main_english()
...
def lacag_qaladantay():
    enter = input("Enter your marchrchent id ")
